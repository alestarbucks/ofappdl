...
for p in range(nproblems):
    ...
    if mode == "train":
        ndishes = r.randint(2,3)
        ningr = ndishes * 3
        nrooms = r.randint(2,4)
        nplants = r.randint(1,5)
        ncookingtools = r.randint(1,3)
        ncleaningtools = r.randint(1,3)
        ngardeningtools = r.randint(1,3)
    else:
        ndishes = r.randint(10, 20)
        ningr = r.randint(ndishes * 3, ndishes * 4)
        nrooms = r.randint(10, 30)
        nplants = r.randint(10, 30)
        ncookingtools = r.randint(5, 15)
        ncleaningtools = r.randint(5, 15)
        ngardeningtools = r.randint(5, 15)
